...
public class RemoveItemAction implements IAction {

    IStoreService m_storeService;
    IStore m_store;
    IItem m_item;
    final String m_name = "Removed Item "; 
    public RemoveItemAction(IStoreService storeService, IStore store, IItem item) {
    ...
    public String getActionName(){
        Integer id = m_item.getID();
        return m_name+id.toString();
    }
}